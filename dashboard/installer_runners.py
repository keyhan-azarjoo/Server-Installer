...
from port_manager import _is_windows_tcp_port_usable, get_port_usage, is_local_tcp_port_listening, manage_firewall_port
...
def run_dashboard_update(live_cb=None):
    ...
    try:
        ...
        files = [
            ...
            "dashboard/utils.py",
            "dashboard/cert_manager.py",
            "dashboard/system_info.py",
            "dashboard/port_manager.py",
            ...
            "dashboard/installer_runners.py",
            "dashboard/pages.py",

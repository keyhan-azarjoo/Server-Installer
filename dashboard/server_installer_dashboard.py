...
"""
    ...
    entrypoint_lines = [
        ...
        f"openclaw config set models.default.model {llm_model} 2>/dev/null || true",
        f"openclaw config set models.default.baseUrl {ollama_url or 'http://127.0.0.1:11434'} 2>/dev/null || true",

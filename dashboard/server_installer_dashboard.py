...
"""
    ...
    entrypoint_lines = [
        ...
        "mkdir -p $AGENT_DIR",
        f'cat > $AGENT_DIR/auth-profiles.json << \'AUTHEOF\'',
        '{',
        '  "ollama": {',
        '    "provider": "ollama",',
        f'    "baseUrl": "{ollama_url or "http://127.0.0.1:11434"}",',
        '    "apiKey": "ollama"',
        '  }',
        '}',
        'AUTHEOF',
        ...
        f"openclaw config set models.ollama.baseUrl \"{ollama_url or 'http://127.0.0.1:11434'}\" 2>&1 || true",
        "",
        ...
        f"cfg['agent']['model'] = 'ollama/{llm_model}'",
        "cfg['agent']['provider'] = 'ollama'",
        f"cfg['defaultModel'] = 'ollama/{llm_model}'",
        "cfg['defaultProvider'] = 'ollama'",
        "cfg.setdefault('models', {}).setdefault('ollama', {})",
        f"cfg['models']['ollama']['baseUrl'] = '{ollama_url or 'http://127.0.0.1:11434'}'",
        "cfg['models']['ollama']['provider'] = 'ollama'",
        "json.dump(cfg, open(cfg_path, 'w'), indent=2)",
        "print('openclaw.json patched successfully')",
        "PYEOF",
        "  cat $OC_CFG",
        "fi",
        "",

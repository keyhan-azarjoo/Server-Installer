...
"""
    ...
    entrypoint_lines = [
        ...
        "fi",
        "",
        "# Clean old agent config that may default to anthropic",
        ...
        '}',
        'AUTHEOF',
        "echo 'Auth profiles written: $AGENT_DIR/auth-profiles.json'",
        "cat $AGENT_DIR/auth-profiles.json",
        "",
        "# Write agent settings to make Ollama the default model",
        f'cat > $AGENT_DIR/settings.json << \'SETTEOF\'',
        '{',
        ...
        '}',
        'SETTEOF',
        "echo 'Agent settings written: $AGENT_DIR/settings.json'",
        "cat $AGENT_DIR/settings.json",
        "",
        "# Also write global config.yaml to set default model",
        ...
        f"  baseUrl: {ollama_url or 'http://127.0.0.1:11434'}",
        "CFGEOF",
        "echo 'Global config updated with default model.'",
        "",

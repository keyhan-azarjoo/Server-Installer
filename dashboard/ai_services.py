...
"""
    ...
    entrypoint_lines = [
        ...
        *(
        ...
        "# Do not write an explicit Ollama provider block here.",
        "# OpenClaw's native Ollama integration auto-discovers models from",
        "# http://127.0.0.1:11434 when OLLAMA_API_KEY/auth profiles are present.",
        "# We already start a local proxy on that port, so letting OpenClaw",
        "# discover models natively preserves the correct /api/chat behavior",
        "# and avoids mismatches from our hand-written model catalog.",
        ...
        "if lmstudio_model and lmstudio_model not in lmstudio_models:",
        "  lmstudio_models.append(lmstudio_model)",

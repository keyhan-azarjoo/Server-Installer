...
"""
    ...
    entrypoint_lines = [
        ...
        "fi",
        "",
        "# Pre-start config (keep this minimal; forcing control-ui and proxy keys",
        "# has caused HTTP 500 failures on newer OpenClaw releases inside Docker).",
        ...
        "PYEOF",
        "",
        "# Keep gateway auth/controlUi at OpenClaw defaults (newer versions can return 500",
        "# when forced into legacy token/insecure/device-auth combinations).",
        "",
        ...
        "ps aux | grep -E 'openclaw|node /tmp/start-gw.js' | grep -v grep || true",
        "",
